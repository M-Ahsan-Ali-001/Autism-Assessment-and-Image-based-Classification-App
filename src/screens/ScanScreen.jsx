  ...
  const webReq = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://da045680-9472-4326-842a-22d289790e66-00-27lc5w6klpzyx.sisko.replit.dev/uploadfile/',
        formData,
        config,
      );
      ...
      SharedPreferences.getItem('userid', function (value) {
        ...
        try {
          const response2 = axios.post(
            'https://dashborad-autism.netlify.app/.netlify/functions/model_ins',
            {
              id: `${value}`,
              date: `${today}`,
              score: `${lt[1]}`,
